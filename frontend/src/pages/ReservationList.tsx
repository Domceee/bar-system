...
export default function ReservationList() {
  ...
  function decline() { openReservationForm(); }
    ...
    return (
      <div className="bar-form-page">
        <div className="bar-form">
          ...
          <div className="bar-form__actions">
            <button className="btn btn--ghost" onClick={decline}>Cancel</button>
    ...
    return (
      <div className="bar-form-page">
        <div className="bar-form">
          ...
          <div className="bar-form__actions">
            <button className="btn btn--primary" onClick={openReservationForm}>Make Another</button>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="bar-form-page">
        <div className="bar-form">
          ...
          <div className="bar-form__actions">
            <button className="btn btn--primary" onClick={openReservationForm}>Try Again</button>
          </div>
        </div>
      </div>
    );

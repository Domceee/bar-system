  ...
  return (
    <div className="bar-list">
      <div className="bar-list__header">
        <h1 className="bar-list__title">
          <span>Bars</span>
        </h1>
        <button className="btn btn--primary" onClick={pressAdd}>
          + Add Bar
        </button>
      </div>
                ...
                <td>
                  <div className="bar-table__actions">
                    <button
                      ...
                      onClick={() => pressEdit(bar.id)}
                    >
                      <Pencil size={15} />
                    </button>
                    <button
                      className="btn btn--delete btn--icon"
                      onClick={() => pressDelete(bar.id)}
                    >
                      <Trash2 size={15} />
                    </button>
                  </div>
